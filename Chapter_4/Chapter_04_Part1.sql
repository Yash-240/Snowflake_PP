...
create storage integration PARK_INN_INTEGRATION
  ...
  storage_allowed_locations = ('s3://parkinnorders0077/');

-- i did the below modification to allow both locations to be accessed using the same integration
ALTER STORAGE INTEGRATION PARK_INN_INTEGRATION
SET STORAGE_ALLOWED_LOCATIONS = (
  's3://bakeryorders007/',
  's3://parkinnorders0077/'
);
